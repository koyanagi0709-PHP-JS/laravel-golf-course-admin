...
return [
    ...
    */
    ...
    'ascii' => ':attributeは半角英数字と記号のみがご利用できます。',
    ...
    'password' => [
        'letters' => ':attributeは、少なくとも一つの文字を含める必要があります。',
        'mixed' => ':attributeは、少なくとも一つの大文字と一つの小文字を含める必要があります。',
        'numbers' => ':attributeは、少なくとも一つの数字を含める必要があります。',
        'symbols' => ':attributeは、少なくとも一つの記号を含める必要があります。',
        'uncompromised' => '指定された:attributeは、データ漏洩に現れています。別の:attributeを選んでください。',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => '電話番号',
        'address' => '住所',
        'form_email' => 'お問い合わせメール',
        'locale' => '言語コード',
        'country_code' => '国コード',
        'state_prefecture' => '都道府県・州',
        'web' => '公式サイトURL',
        'indoor' => '屋内コースフラグ',
        'outdoor' => '屋外コースフラグ',
        'short_course' => 'ショートコースフラグ',
        'long_course' => 'ロングコースフラグ',
        'image1' => '画像1',
        'image2' => '画像2',
        'image3' => '画像3',
    ],
